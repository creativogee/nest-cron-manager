...
export class Init1731234924065 implements MigrationInterface {
    name = 'Init1731234924065'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cron_manager_control" ("id" SERIAL NOT NULL, "enabled" boolean NOT NULL DEFAULT true, "logLevel" character varying, "replicaIds" jsonb NOT NULL DEFAULT '[]', "staleReplicas" jsonb NOT NULL DEFAULT '[]', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "cmcv" character varying NOT NULL, CONSTRAINT "PK_9907973df9437e9a3c71fab2e8a" PRIMARY KEY ("id"))`);
